...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Function executable only by owner");
        _;
    }
...
//  5) create a Paused & Unpaused event that emits the address that triggered the event
    event PauseUnpauseAddress(address owner);
//  3) create an internal constructor that sets the _paused variable to false
    constructor() internal {
        _paused = false;
        emit PauseUnpauseAddress(msg.sender);
    }
//  2) create a public setter using the inherited onlyOwner modifier 
    function operational() public onlyOwner {
        _paused = !_paused;
        emit PauseUnpauseAddress(msg.sender);
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "Given address is already owner of tokenId");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "From address is not owner of given tokenID");
        // TODO: require token is being transfered to valid address
        require(to != address(0), "Reciever tokenId address is invalid");
        // TODO: clear approval
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function getTokenInfo() external view returns(string memory name, string memory symbol, string memory baseTokenURI){
        name = _name;
        symbol = _symbol;
        baseTokenURI = _baseTokenURI;
        return(name,symbol,baseTokenURI);
    }
...
contract CustomERC721Token is ERC721Metadata('Token_Name','TN','https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/') {
