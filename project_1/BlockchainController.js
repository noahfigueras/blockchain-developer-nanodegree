...
class BlockchainController {
    ...
    getBlockByHash() {
        this.app.get("/blocki/:hash", async (req, res) => {
            if(req.params.hash) {
    ...
    // This endpoints allows you to validate blocks on the chain.
    validateChain(){
        this.app.get("/validateChain", async (req,res) => {
            ...
            if(errorLog > 0){
                ...
                return res.status(304).send('Everything is good on the blockchain')
            }
        })
    }
